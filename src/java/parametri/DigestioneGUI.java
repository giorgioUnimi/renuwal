 ...
 * @author giorgio
 */
@ManagedBean(name = "digestioneGUI")
@ViewScoped

public class DigestioneGUI implements Serializable{
   ...
   private void inizializzaParametri()
   {
     ...
     /* Query q = entityManager.createQuery("SELECT p FROM ParametridiprogettoS p WHERE p.idScenario =?1 AND p.idTrattamento=?2 ");
      ...
      q.setParameter(2,tra);*/
         classeparametri = new Parametridiprogetto("renuwal2",9,dettCuaa.getIdscenario());
