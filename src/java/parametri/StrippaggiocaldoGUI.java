 ...
 * @author giorgio
 */
@ManagedBean(name = "strippaggiocaldoGUI")
@ViewScoped

public class StrippaggiocaldoGUI implements Serializable{
  ...
  /**
   ...
   // private String tipobiomassa1 = "5" ;
    ...
    private Double potenza_termica_necessaria;
   ...
   private void inizializzaParametri()
   {
     ...
     /* Query q = entityManager.createQuery("SELECT p FROM ParametridiprogettoS p WHERE p.idScenario =?1 AND p.idTrattamento=?2 ");
      ...
      q.setParameter(2,tra);*/
         classeparametri = new Parametridiprogetto("renuwal2",15,dettCuaa.getIdscenario());
     ...
     while(iterPa.hasNext())
     {
         ...
         switch(temp.getIdNomeparametro().getId())
         {
             ...
             case 149:
                 ...
                 this.costo_energia_termica = new Double(Double.parseDouble(temp.getValore()));
                 break;
             case 61:
       ...
       if(tt < 6 && tt > 0)
       {
        ...
        switch (action) {
             ...
             case "148":
                ...
                temp.setValore(String.valueOf(this.potenza_termica_necessaria.doubleValue()));
                break;     
               
             case "149":
                temp = classeparametri.getParametrodiprogetto(0, 149,null,null, null);
                temp.setValore(String.valueOf(this.costo_energia_termica.doubleValue()));
                break;        
             case "61":
...
//    }
    ...
    public void setPotenza_termica_necessaria(Double potenza_termica_necessaria) {
        if(potenza_termica_necessaria != null) {
