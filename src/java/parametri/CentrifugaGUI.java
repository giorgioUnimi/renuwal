 ...
 * @author giorgio
 */
@ManagedBean(name = "centrifugaGUI")
@ViewScoped
public class CentrifugaGUI implements Serializable{
  ...
  Parametridiprogetto classeparametri = null;
   ...
   public CentrifugaGUI()
   {
      ...
      DettaglioCuaa dettCuaa = (DettaglioCuaa) FacesContext.getCurrentInstance().getApplication().getELResolver().getValue(elContext, null, "dettaglioCuaa");
       ...
       classeparametri = new Parametridiprogetto("renuwal2",11,dettCuaa.getIdscenario());
    ...
    public String getValorecoefficiente() {
     ...
     /* ELContext elContext = FacesContext.getCurrentInstance().getELContext();
      DettaglioCuaa dettCuaa = (DettaglioCuaa) FacesContext.getCurrentInstance().getApplication().getELResolver().getValue(elContext, null, "dettaglioCuaa");
                ...
                System.out.println(" prima " + this.getClass().getCanonicalName() +"  sono nellif   metodo " +Thread.currentThread().getStackTrace()[1].getMethodName()+" valorecoefficiente " + this.valorecoefficiente + " this.coefficientemaccchina " +this.coefficientemaccchina + " this.coefficientetipomacchina " +this.coefficientetipomacchina );
                 ...
                 System.out.println("dopo " + this.getClass().getCanonicalName() +"  sono nellif   metodo " +Thread.currentThread().getStackTrace()[1].getMethodName()+" valorecoefficiente " + this.valorecoefficiente + " this.coefficientemaccchina " +this.coefficientemaccchina + " this.coefficientetipomacchina " +this.coefficientetipomacchina );
        }
...
public void aggiorna()
{
   ...
   /*if(action.equals("1"))
    ...
    System.out.println("action " + action + " this.coefficientemaccchina " + this.coefficientemaccchina + " this.coefficientetipomacchina " + this.coefficientetipomacchina + " valore " + temp.getValore());
