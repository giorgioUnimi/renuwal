 ...
 * @author giorgio
 */
@ManagedBean(name = "vascaGUI")
@ViewScoped

public class VascaGUI implements Serializable{
    ...
    */
   //private List<db.ParametridiprogettoS> parametri = new LinkedList<db.ParametridiprogettoS> ();
   ...
   /**
    * tipo di stoccaggio selezionato in vasca.xhtml mediante selectonemenu
    */
   private String stoccaggio="1";
   /**
    * tipo di stoccaggio selezionato in vasca.xhtml mediante selectonemenu
    */
   private String stoccaggio1="1";
   /**
   ...
   private Double valorecoefficiente1 = new Double(0d);
    ...
    /**
    *FINE - di seguito la lista dei parametri di progetto del trattamento vasca
    */
   ...
   public VascaGUI()
   {
       ...
       // ContenitoreAziendale contenitore = ContenitoreAziendale.getInstance(detto.getCuaa());
        ...
        // contenitoreIniziale = contenitore.getContenitore();
          ...
          contenitoreIniziale = Vasca.getInstance().getContenitoreRefluiIn();
   ...
   private void inizializzaParametri()
   {
     ...
     /* Query q = entityManager.createQuery("SELECT p FROM ParametridiprogettoS p WHERE p.idScenario =?1 AND p.idTrattamento=?2 ");
      ...
      q.setParameter(2,tra);*/
         classeparametri = new Parametridiprogetto("renuwal2",6,dettCuaa.getIdscenario());
...
//   /**
//    * imposta la lista dei parametri diprogetto per la vasca
//    */
//   private void recuperaParametri()
//   {
//       /**
//        * svuoto la lista dei parametri di progetto
//        */
...
//       // DettaglioCuaa dett1Cuaa = new DettaglioCuaa();
//      Query q = entityManager.createQuery("SELECT p FROM ParametridiprogettoS p WHERE p.idScenario =?1 AND p.idTrattamento=?2");
//      q.setParameter(1, sce);
//      q.setParameter(2,tra);
//      List<db.ParametridiprogettoS> pa= (List<db.ParametridiprogettoS>)q.getResultList();
...
//        
//        
//        System.out.println(this.getClass().getCanonicalName()+" numero parametri  " + pa.size() + " scenario " + dettCuaa.getIdscenario() );
//        
//        
//        for(db.ParametridiprogettoS para:pa)
//        {
//           // System.out.println(this.getClass().getCanonicalName() + " parametri nome " + para.getIdNomeparametro().getNome() + " valore " + para.getValore());
//            
//           this.parametri.add(para); 
//        }
//        
//   }
...
//       
//       
//       Vasca vasca = Vasca.getInstance();
//      
//       if(vasca.getContenitoreRefluiIn().totale("Liquame").getMetricubi() != 0)
//        {
//       
//       this.setCh4(vasca.getCh4());
//       this.setNh3(vasca.getNh3());
//       this.setCo2(vasca.getCo2());
//       this.setN2(vasca.getN2());
//       this.setN2o(vasca.getN2o());
//        }
//   }
//   
//   
...
//          if(vasca.getContenitoreRefluiIn().totale("Liquame").getMetricubi() != 0)
//          {
//                this.setStoccaggidarealizzare(vasca.getStoccaggidarealizzare());
//                this.setStoccaggipresenti(vasca.getStoccaggipresenti());
//                this.setStoccaggirichiesti(vasca.getStoccaggirichiesti());
//                
//          }
//   }
//   
//   
//   private void aggionraGestionali()
//   {
//       Vasca vasca = Vasca.getInstance();
//       
//        // if(vasca.getContenitoreRefluiIn().totale("Liquame").getMetricubi() != 0)
//         {
//            this.setCostocomplessivo(vasca.getInvestimento());
//            this.setCostomanutenzione(vasca.getEsercizio());
//            this.setEnergiaconsumata(vasca.getEnergiaconsumata());
//                this.setEnergiaprodotta(vasca.getEnergiaprodotta());
//                this.setEnergiavenduta(vasca.getEnergiavenduta());
//                this.setVenditacompost(vasca.getCompostvenduto());
//                this.setSolidoessiccato(vasca.getSolidoessiccato());
//         }
//   }
//    
//    public void calcola()
...
//        
//        
//        //vasca.azzeraContenitori();
//        /**
//         * imposto il suo contenitore dei reflui a quello iniziale del session bena in questione
//         * che è SeparazioneGUI
//         */
//        vasca.setContenitoreRefluiIn(contenitoreIniziale);
//        
//        /**
//         * 
//         */
//        //vasca.calcolaEmissioni();
//        //vasca.calcolaGestionali();
//       // vasca.calcolaRefluo();
//        
//        
//        /**
...
//         */
//        
//        ContenitoreReflui contenitorereflui = vasca.getContenitoreRefluiOut();
//        
//        /**
...
//    }
    ...
    public void setListaCaratteristicheLiq(List<Refluo> listaCaratteristicheLiq) {
        this.setListaCaratteristicheLiq(listaCaratteristicheLiq);
    }
    ...
    public void setListaCaratteristicheLet(List<Refluo> listaCaratteristicheLet) {
        this.setListaCaratteristicheLet(listaCaratteristicheLet);
    }
     ...
     */
   /* public List<db.ParametridiprogettoS> getParametri() {
        return parametri;
    }
     ...
     */
  /*  public void setParametri(List<db.ParametridiprogettoS> parametri) {
          ...
          /*  entityManagerFactory = Persistence.createEntityManagerFactory("renuwal2");
             entityManager = entityManagerFactory.createEntityManager();
               ...
               /*  Query q1 = entityManager.createNamedQuery("ScenarioI.findByIdscenario").setParameter("idscenario",dettCuaa.getIdscenario());
                 ...
                 q1 = entityManager.createNamedQuery("TrattamentoS.findById").setParameter("id",6);
               ...
               //  Parametridiprogetto classeparametri = new Parametridiprogetto("renuwal2",6,dettCuaa.getIdscenario());
            
                System.out.println("prima della ricerca in parametri di progetto coefficienteemissione " + Integer.parseInt(this.coefficienteemissione) +" stoccaggio   " +this.stoccaggio);
    ...
    public void setValorecoefficiente(Double valorecoefficiente) {
        ...
        {
         System.out.println(this.getClass().getCanonicalName() + "  setValorecoefficiente()" );
    ...
    /**
     * @return the giornistoccaggiobovino
     */
    public String getGiornistoccaggiobovino() {
        return giornistoccaggiobovino;
    }

    /**
     * @param giornistoccaggiobovino the giornistoccaggiobovino to set
     */
    public void setGiornistoccaggiobovino(String giornistoccaggiobovino) {
        if(giornistoccaggiobovino != null && giornistoccaggiobovino.length() != 0) {
            this.giornistoccaggiobovino = giornistoccaggiobovino;
        }
    }

    /**
     * @return the giornistoccaggiosuino
     */
    public String getGiornistoccaggiosuino() {
        return giornistoccaggiosuino;
    }

    /**
     * @param giornistoccaggiosuino the giornistoccaggiosuino to set
     */
    public void setGiornistoccaggiosuino(String giornistoccaggiosuino) {
        if(giornistoccaggiosuino != null && giornistoccaggiosuino.length()!= 0) {
            this.giornistoccaggiosuino = giornistoccaggiosuino;
        }
    }

    /**
     * @return the giornistoccaggioavicolo
     */
    public String getGiornistoccaggioavicolo() {
        return giornistoccaggioavicolo;
    }

    /**
     * @param giornistoccaggioavicolo the giornistoccaggioavicolo to set
     */
    public void setGiornistoccaggioavicolo(String giornistoccaggioavicolo) {
        if(giornistoccaggioavicolo != null && giornistoccaggioavicolo.length()!=0) {
            this.giornistoccaggioavicolo = giornistoccaggioavicolo;
        }
    }

    /**
     * @return the giornistoccaggioaltri
     */
    public String getGiornistoccaggioaltri() {
        return giornistoccaggioaltri;
    }

    /**
     * @param giornistoccaggioaltri the giornistoccaggioaltri to set
     */
    public void setGiornistoccaggioaltri(String giornistoccaggioaltri) {
        if(giornistoccaggioaltri != null && giornistoccaggioaltri.length() != 0) {
            this.giornistoccaggioaltri = giornistoccaggioaltri;
        }
    }

    /**
     * @return the giornistoccaggiobiomasse
     */
    public String getGiornistoccaggiobiomasse() {
        return giornistoccaggiobiomasse;
    }

    /**
     * @param giornistoccaggiobiomasse the giornistoccaggiobiomasse to set
     */
    public void setGiornistoccaggiobiomasse(String giornistoccaggiobiomasse) {
        if(giornistoccaggiobiomasse != null && giornistoccaggiobiomasse.length()!= 0 ) {
            this.giornistoccaggiobiomasse = giornistoccaggiobiomasse;
        }
    }
