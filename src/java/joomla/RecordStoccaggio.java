 ...
 * @author giorgio
 */
@ManagedBean(name="recordStoccaggioJ")
@ViewScoped
public class RecordStoccaggio {
    ...
    private String superficiescoperta;
     ...
     */
    public void setSuperficiescoperta(String superficiescoperta) {
    ...
    public ArrayList getDescrizioneLista() {
        ...
        try {
            ...
            this.descrizioneLista.add(new SelectItem("------"));
            for (int i = 0; i < results.size(); i++) {
