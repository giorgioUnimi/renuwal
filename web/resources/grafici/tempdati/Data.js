var dataString ='<chart palette="3" caption="Test grafico" subcaption="Qui e\' possibile inserire una descrizione" yAxisName="asse Y " xAxisName="asse X" showLegend="1" showNames="1" xAxisMaxValue="10" xAxisMinValue="0" showFormBtn="0" numberSuffix="%" >\n\
...
var dataString1 ='<chart palette="3" caption="Test grafico" subcaption="Qui e\' possibile inserire una descrizione" yAxisName="asse Y " xAxisName="asse X" showLegend="1" showNames="1" xAxisMaxValue="10" xAxisMinValue="0" showFormBtn="0" numberSuffix="%" >\n\
<categories verticalLineThickness="1">\n\
	<category name="1" x="1" showVerticalLine="1"/>\n\
	<category name="2" x="2" showVerticalLine="1"/>\n\
	<category name="3" x="3" showVerticalLine="1"/>\n\
